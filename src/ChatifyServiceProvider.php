...
class ChatifyServiceProvider extends ServiceProvider
{
    ...
    protected function setPublishes()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/database/migrations/2022_01_10_99999_create_favorites_table.php' => database_path('migrations/' . date('Y_m_d') . '_999999_create_chatify_favorites_table.php'),
